...
function onCreate()
   ...
   if not lowQuality then
	...
	addAnimationByPrefix('faces', 'portraitsBF', 'bfFadeIns',6,true)
	...
	if not lowQuality then
		...
		addAnimationByPrefix('jazz', 'ouukillem', 'jasmineCombat',12,true)
		scaleObject('jazz', '2','2');
