...
function onCreate()
	...
	if not lowQuality then
		...
		addAnimationByPrefix('police2', 'uhoh', 'helicopters',8,true);
                scaleObject('police2', 2, 2)
	...
	addAnimationByPrefix('newYork', 'ground', 'newGround',18,true);
        scaleObject('newYork', 2, 2)
	...
	addAnimationByPrefix('newYork2', 'light', 'lightsMove',18,true);
        scaleObject('newYork2', 2, 2)
	...
	addAnimationByPrefix('police', 'weewoo', 'policeChase',20,true);
	...
	addAnimationByPrefix('parents', 'wee', 'dadAppear',6,true);
	...
	addAnimationByPrefix('parents2', 'vroom', 'car',12,true);
	...
	if not lowQuality then
		...
		addAnimationByPrefix('smoke', 'byebye', 'heart explode',12,false);
